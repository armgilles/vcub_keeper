...
# Read simulated data
station_json_loaded_simu = generate_data(num_stations=15, num_days=7, seed=2024)  # (15135, 8)
station_json_loaded_simu_big = generate_data(num_stations=50, num_days=20, seed=2024)  # (144000, 8)
